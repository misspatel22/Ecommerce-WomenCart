    ...
    <Fragment>
      <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full bg-white">
        ...
        <div className="hidden lg:block">
          <span
            onClick={(e) => history.push("/homepage")}
            style={{ letterSpacing: "0.20rem" }}
            className="flex items-left text-center font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 text-center"
          >
            <h1 className=' text-2xl font-bold text-blue-600 px-2 py-1 rounded' >WOMEN<span className='text-orange-600'>CART</span></h1>
          </span>
        </div>
        {/* Small Screen Show */}
...
//       <nav className="sticky z-20 flex shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full bg-white">

//         {/*  Large Screen Show  */}
//         <div className="hidden lg:block lg:flex  lg:space-x-4 my-2">
//           <span>
//             <svg
//               className="w-8 h-8 cursor-pointer text-gray-600"
//               fill="none"
...
//             onClick={(e) => history.push("/homepage")}
//             style={{ letterSpacing: "0.10rem" }}
//             className="flex items-left  font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 my-2"
//           >
//             <h1 className=' text-2xl font-bold text-blue-600 px-2 py-1 rounded' >WOMEN<span className='text-orange-600'>CART</span></h1>
...
//         <div div className=" px-2 py-2 md:px-8 top-0 ">
//           <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
//             <div className="col-span-1 lg:hidden flex">
//               <svg onClick={(e) => navberToggleOpen()}
//                 className="col-span-2 lg:hidden w-8 h-8 cursor-pointer text-gray-600"
//                 id="hamburgerBtn"
...
//             >
//               <span className=' font-bold text-dark' >Dashboard</span>
//             </span>
//             <span
//               className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
...
//             >
//               <span className=' font-bold text-dark' >Product</span>
//             </span>

//             <span
//               className="font-light tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
//               onClick={(e) => history.push("/admin/dashboard/orders")}
//             >
//               <span className='font-bold text-dark'>Order</span>
//             </span>
//           </div>
//         </div>
//         {/* </nav> */}
...
//           {/* <div className="hover:bg-gray-200 rounded-lg p-2 dark-mode" title="dark-mode" onClick={toggleDarkMode}>
//             <svg
//               className="cursor-pointer w-8 h-8 text-gray-600 hover:text-gray-800"
//               fill="none"
//               stroke="currentColor"
