    ...
    <Fragment>
      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-2">
            <span
              className="hover:bg-gray-200 px-2 py-2 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
            ...
            >
              <span className="font-bold text-dark">About us</span>
            </span>
            {/* <span
              className="hover:bg-gray-200 px-2 py-2 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/testimonial")}
            >
              <span className="font-bold text-dark">Testimonial</span>
            </span> */}
            <span
              className="hover:bg-gray-200 px-2 py-2 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/shop")}
            >
              <span className="font-bold text-dark">Shop</span>
            </span>
            <span
              className="hover:bg-gray-200 px-2 py-2 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/Contact-Us")}
            >
              <span className="font-bold text-dark">Contact us</span>
            </span>
          </div>
